import { View, Text, useWindowDimensions, SafeAreaView, TouchableOpacity, Image, ImageBackground } from 'react-native'
    ...
    return (
        <ImageBackground
            ...
            style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{borderWidth: 1, borderColor: "black", borderRadius: 20, alignSelf: "center", width: 310, padding: 10, backgroundColor: "#CB905A"}}>
                ...
                <View style={{alignItems: 'center', marginTop: 10, borderRadius: 20, padding: 1}}>
                    ...
                    <View style={{borderWidth: 1, borderColor: "gray", borderRadius: 20, padding: 10, alignSelf: "center", width: 150, backgroundColor: "#91e8fa"}}>
